...
echo "Building Docker image for 10.1.20.130:5001/dropping/file-service:test" >/dev/stderr
docker build -t "10.1.20.130:5001/dropping/file-service:test" --build-arg BIN_NAME=$service_name -f Dockerfile .
